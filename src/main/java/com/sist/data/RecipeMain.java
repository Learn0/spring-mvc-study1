...
public class RecipeMain {
	 ...
	 * 
	 * 
	 * <div class="list_lump"> <div class="list_ranking2"> <p
	 * class="list_ranking2_num ">1</p> <p class="list_ranking2_num2"><span
	 * style="color:#fff;" class="glyphicon "></span></p> </div> <div
	 * class="list_mem3"> <a href="/profile/index.html?uid=jun8707"
	 * class="mem_pic"><img src=
	 * "https://recipe1.ezmember.co.kr/cache/rpf/2016/01/19/3ebaebc5e49f53dd2f66b71932e5a33d1.jpg"
	 * ></a> </div> <div class="list_cont4"><b> <a
	 * href="/profile/index.html?uid=jun8707" id="folFriend_jun8707"
	 * class="info_name_f"> 시크제이맘 </a> <button type="button"
	 * class="btn btn-default btn-sm" id="btnActFriend_jun8707" fact="insert"
	 * onClick="doActFriend('jun8707')"> <span
	 * class="glyphicon glyphicon-plus"></span>소식받기 </button> </b> <span
	 * class="mem_cont1">1,712</span><span class="mem_cont3">1,188,441</span><span
	 * class="mem_cont7">40,430,313</span><span class="mem_cont2">24,467</span>
	 * </div> </div>
	 */
	...
	public void goodsListData() {
		/*
		 * PRODUCT_NAME NOT NULL VARCHAR2(1000) PRODUCT_PRICE NOT NULL NUMBER
		 * PRODUCT_POSTER NOT NULL VARCHAR2(260) <ul class="common2_sp_list_ul ea3"> <li
		 * class="common2_sp_list_li"><a href=
		 * "https://shop.10000recipe.com/goods/goods_view.php?goodsNo=1000021160&utm_source=10k_web&utm_medium=category_list&utm_campaign=g%5B%EB%A7%8C%EA%B0%9C%ED%8A%B9%EA%B0%80%5D%EC%98%81%EC%96%91%EA%B0%84%EC%8B%9D%EC%8A%A4%ED%8A%B8%EB%A1%B1%EC%88%8F%EB%8B%A4%EB%A6%AC1%EB%B4%8924-32%EB%AF%B8%28250g%29"
		 * class="common2_sp_link"></a><div class="common2_sp_thumb"><img src=
		 * "https://recipe1.ezmember.co.kr/cache/data/goods/21/07/28/1000021160/1000021160_detail_042.jpg"
		 * ></div> <div class="common2_sp_caption"> <div
		 * class="common2_sp_caption_tit line2">[만개특가] 영양간식 스트롱숏다리 1봉 24-32미(250g)</div>
		 * <div class="common2_sp_caption_price_box"><span
		 * class="common2_sp_caption_per"><b>31</b>%</span> <strong
		 * class="common2_sp_caption_price"><span>8,900</span><small>원</small></strong><
		 * /div><div class="common2_sp_caption_rv2"> <span
		 * class="caption_rv2_img"></span><b class="caption_rv2_pt">4.6</b><span
		 * class="caption_rv2_ea">(573)</span> </div><div
		 * class="common2_sp_caption_icon"></div></div></li><li
		 * class="common2_sp_list_li"><a href=
		 * "https://shop.10000recipe.com/goods/goods_view.php?goodsNo=1000023475&utm_source=10k_web&utm_medium=category_list&utm_campaign=g%EC%BC%80%EC%96%B4%ED%8C%9F%EC%8A%A4%ED%85%8C%EC%9D%B8%EB%A6%AC%EC%8A%A4%ED%81%90%EB%B8%8C%EA%B0%80%EC%8A%B5%EA%B8%B0x40"
		 * class="common2_sp_link"></a><div class="common2_sp_thumb"><img src=
		 * "https://recipe1.ezmember.co.kr/cache/data/goods/21/10/42/1000023475/1000023475_detail_016.jpg"
		 * ></div>
		 */
		try {
			// 사이트 연결 => HTML데이터 읽기
